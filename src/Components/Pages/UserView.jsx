...
const UserView = (props) => {
    ...
    useEffect(() => {
        var url = "user/all?UserId=" + UserId;
        //alert(url);
        axios.get(url)
            .then(resp => {
                                                    ...
                                                    <tbody>
                                                        {
                                                            apiData.map((p, index) => (
                                                                <tr key={index}>
                                                                    ...
                                                                    <td>{p.MaxContacts}</td>
                                                                    <td>{p.MaxApiKeys}</td>
                                                                    <td>{p.MaxTemplates}</td>


                                                                    <td>
                                                                        <Link to={"/user/edit/" + p.Id + ""} className="action-icon"> <i className="mdi mdi-square-edit-outline"></i></Link>
                                                                        <Link to={"/user/delete/" + p.Id + ""} className="action-icon"> <i className="mdi mdi-delete"></i></Link>
                                                                    </td>
                                                                </tr>
